function price = E3_callPriceLewis(discount, F0, alpha, moneyness, sigma, k, eta, timeToMaturity, flag, M, dz, flag_model)
...
% function E3_quadrature(x_grid, sigma, TTM, k, eta, alpha)
    ...
    switch (flag)
        ...
        case 1  % FFT
            [Z, IntLewis] = E3_integralLewisFFT(M, dz, alpha, sigma, k, eta, timeToMaturity, flag_model);
        ...
        case 2  % Quadrature
            IntLewis = E3_quadrature(moneyness, sigma, timeToMaturity, k, eta, alpha, flag_model);

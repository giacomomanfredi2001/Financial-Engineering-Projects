function fwdDiscounts = treeForwardDiscounts (dates, discounts, yfTree)
...
% yfTree:           year fractions of the tree time steps 
    ...
    fwdDiscounts = treeDiscounts(2:end)./treeDiscounts(1:end-1);

end % function treeForwardDiscounts